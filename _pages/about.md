...
I am a Senior Applied Scientist at Microsoft. I received my Ph.D. in [Computer Science](https://cs.vt.edu/) at [Virginia Tech](https://vt.edu/), where I was advised by Prof. [Lifu Huang](https://wilburone.github.io/). Previously, I received my Bachelor's Degree in the [School of CSE](http://www2.scut.edu.cn/cs_en/), [South China University of Technology (SCUT)](https://www.scut.edu.cn/en/). I was a research intern at Bloomberg CTO Office in Summer 2025, a Research Intern at Microsoft in Summer 2024, and an Applied Scientist Intern at AWS AI in Summer 2023. [[Google Scholar](https://scholar.google.com/citations?user=xCR8nrwAAAAJ&hl=en)][[CV (Updated on Oct 2025)](https://mqianliu.github.io/files/minqianliu_cv.pdf)].
...
## Research Interests
Currently, I am interested in the following topics: <br>
<!-- 1) **Language technology for real-world applications:** continual learning and few/zero-shot learning for NLP; <br> -->
1) **Evaluation** for large generative models and agentic systems;  <br>
2) **AI Safety**, e.g., alignment and content moderation for large language models; <br>
3) **Continual learning for NLP**: acquiring new knowledge and skills from the evolving environment while retaining previously learned knowledge. <br>
...
## News
**\[2026.4]** My work done during the Bloomberg internship has been accepted to **ACL 2026 Main conference**! Great thanks to my awesome mentors!  <br>
